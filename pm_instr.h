...
#define pmfs_trace_printk(args...)          \
  {                                         \
    if (pmfs_tracemask) trace_printk(args); \
  }
...
#define PM_TX_BEGIN() \
  ({ PM_TRACE("%s:%s:%d\n", PM_TX_START, __FILENAME__, __LINE__); })

#define PM_TX_COMMIT() \
  ({ PM_TRACE("%s:%s:%d\n", PM_TX_END, __FILENAME__, __LINE__); })
...
#define PM_COMMIT() \
  ({ PM_TRACE("%s:%s:%d\n", PM_COMMIT_MARKER, __FILENAME__, __LINE__); })
#define PM_BARRIER() \
  ({ PM_TRACE("%s:%s:%d\n", PM_BARRIER_MARKER, __FILENAME__, __LINE__); })
...
#define PM_FENCE()                                                   \
  ({                                                                 \
    PM_TRACE("%s:%s:%d\n", PM_FENCE_MARKER, __FILENAME__, __LINE__); \
