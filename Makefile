...
wpmfs-y := dir.o file.o inode.o namei.o super.o symlink.o ioctl.o pmfs_stats.o journal.o xip.o wprotect.o wpmfs_proc.o wpmfs_wl.o wpmfs_wt.o wpmfs_balloc.o wpmfs_bbuild.o
